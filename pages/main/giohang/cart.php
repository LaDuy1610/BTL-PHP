       ...
       <?php
        ...
        ?>
               <tr>
                   ...
                   <td><img src="admincp/modules/quanlysp/uploads/<?php echo $cart_item['hinhanh'] ?>" style="height:200px; width:none !important;"></td>

                   <td>
                       <a class="update" href="pages/main/giohang/suasoluong.php?cong=<?php echo $cart_item['id'] ?>">+</a>
                       <?php echo $cart_item['soluong'] ?>
                       <a class="update" href="pages/main/giohang/suasoluong.php?tru=<?php echo $cart_item['id'] ?>">-</a>
                   </td>
